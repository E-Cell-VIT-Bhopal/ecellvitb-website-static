    ...
    function () {
        ...
        if (e) {
            ...
            if (t) {
                ...
                for (var s of i) s.addEventListener("click", (function (e) {
                    a.hide()
                }))
            }
            var r = function () {
    ...
    function (e, t) {
            ...
            prepend: function (t) {
                ...
                for (i = 0; i < this.length; i += 1)
                    if ("string" == typeof t) {
                        ...
                        for (n.innerHTML = t, s = n.childNodes.length - 1; 0 <= s; s -= 1) r[i].insertBefore(n.childNodes[s], r[i].childNodes[0])
                    } else if (t instanceof a)
                    for (s = 0; s < t.length; s += 1) r[i].insertBefore(t[s], r[i].childNodes[0]);
        ...
        var h = {
                updateSize: function () {
                    var e, t, a = this,
                        i = a.$el;
                    e = void 0 !== a.params.width ? a.params.width : i[0].clientWidth, t = void 0 !== a.params.height ? a.params.height : i[0].clientHeight, 0 === e && a.isHorizontal() || 0 === t && a.isVertical() || (e = e - parseInt(i.css("padding-left"), 10) - parseInt(i.css("padding-right"), 10), t = t - parseInt(i.css("padding-top"), 10) - parseInt(i.css("padding-bottom"), 10), d.extend(a, {
                        width: e,
                        height: t,
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== s) {
                        var S, C;
                        "string" == typeof y && 0 <= y.indexOf("%") && (y = parseFloat(y.replace("%", "")) / 100 * s), e.virtualSize = -y, r ? c.css({
                            marginLeft: "",
                            marginTop: ""
                        }) : c.css({
                            marginRight: "",
                        ...
                        for (var M, z = a.slidesPerColumn, k = S / z, P = k - (a.slidesPerColumn * k - u), $ = 0; $ < u; $ += 1) {
                            C = 0;
                            var L = c.eq($);
                            if (1 < a.slidesPerColumn) {
                                var I = void 0,
                                    D = void 0,
                                    O = void 0;
                                "column" === a.slidesPerColumnFill ? (O = $ - (D = Math.floor($ / z)) * z, (P < D || D === P && O === z - 1) && z <= (O += 1) && (O = 0, D += 1), I = D + O * S / z, L.css({
                                    "-webkit-box-ordinal-group": I,
                                    "-moz-box-ordinal-group": I,
                                    "-ms-flex-order": I,
                                    "-webkit-order": I,
                                    order: I
                                })) : D = $ - (O = Math.floor($ / k)) * k, L.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== O && a.spaceBetween && a.spaceBetween + "px").attr("data-swiper-column", D).attr("data-swiper-row", O)
                            }
                            if ("none" !== L.css("display")) {
                                if ("auto" === a.slidesPerView) {
                                    ...
                                    N && (L[0].style.transform = "none"), H && (L[0].style.webkitTransform = "none"), C = e.isHorizontal() ? L[0].getBoundingClientRect().width + parseFloat(A.getPropertyValue("margin-left")) + parseFloat(A.getPropertyValue("margin-right")) : L[0].getBoundingClientRect().height + parseFloat(A.getPropertyValue("margin-top")) + parseFloat(A.getPropertyValue("margin-bottom")), N && (L[0].style.transform = N), H && (L[0].style.webkitTransform = H), a.roundLengths && (C = Math.floor(C))
                                } else C = (s - (a.slidesPerView - 1) * y) / a.slidesPerView, a.roundLengths && (C = Math.floor(C)), c[$] && (e.isHorizontal() ? c[$].style.width = C + "px" : c[$].style.height = C + "px");
                                c[$] && (c[$].swiperSlideSize = C), f.push(C), a.centeredSlides ? (x = x + C / 2 + E / 2 + y, 0 === E && 0 !== $ && (x = x - s / 2 - y), 0 === $ && (x = x - s / 2 - y), Math.abs(x) < .001 && (x = 0), a.roundLengths && (x = Math.floor(x)), T % a.slidesPerGroup == 0 && h.push(x), v.push(x)) : (a.roundLengths && (x = Math.floor(x)), T % a.slidesPerGroup == 0 && h.push(x), v.push(x), x = x + C + y), e.virtualSize += C + y, E = C, T += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, s) + g, r && n && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                            ...
                            for (var G = 0; G < h.length; G += 1) {
                                var B = h[G];
                                a.roundLengths && (B = Math.floor(B)), h[G] < e.virtualSize + h[0] && M.push(B)
                            }
                            h = M
                        }
                        if (!a.centeredSlides) {
                            ...
                            for (var X = 0; X < h.length; X += 1) {
                                var Y = h[X];
                                a.roundLengths && (Y = Math.floor(Y)), h[X] <= e.virtualSize - s && M.push(Y)
                            }
                            h = M, 1 < Math.floor(e.virtualSize - s) - Math.floor(h[h.length - 1]) && h.push(e.virtualSize - s)
                        }
                        0 === h.length && (h = [0]), 0 !== a.spaceBetween && (e.isHorizontal() ? r ? c.css({
                            marginLeft: y + "px"
                        }) : c.css({
                            marginRight: y + "px"
                        }) : c.css({
                ...
                updateProgress: function (e) {
                    ...
                    var t = this,
                        ...
                        o = r,
                        l = n;
                    0 === i ? n = r = !(s = 0) : (r = (s = (e - t.minTranslate()) / i) <= 0, n = 1 <= s), d.extend(t, {
                        progress: s,
                        isBeginning: r,
                        isEnd: n
            ...
            v = {
                ...
                setTranslate: function (e, t) {
                    var a = this,
                        ...
                        o = 0,
                        l = 0;
                    a.isHorizontal() ? o = i ? -e : e : l = e, s.roundLengths && (o = Math.floor(o), l = Math.floor(l)), s.virtualTranslate || (p.transforms3d ? r.transform("translate3d(" + o + "px, " + l + "px, 0px)") : r.transform("translate(" + o + "px, " + l + "px)")), a.previousTranslate = a.translate, a.translate = a.isHorizontal() ? o : l;
            ...
            f = {
                slideTo: function (e, t, a, i) {
                    ...
                    h >= o.length && (h = o.length - 1), (c || n.initialSlide || 0) === (d || 0) && a && s.emit("beforeSlideChangeStart");
                    var v, f = -o[h];
                ...
                slideToClickedSlide: function () {
                    ...
                    if (a.loop) {
                        ...
                        e = parseInt(i(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? n < t.loopedSlides - r / 2 || n > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), n = s.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), d.nextTick((function () {
                            t.slideTo(n)
                        }))) : t.slideTo(n) : n > t.slides.length - r ? (t.loopFix(), n = s.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), d.nextTick((function () {
                            t.slideTo(n)
                        }))) : t.slideTo(n)
                    } else t.slideTo(n)
                }
            ...
            b = {
                ...
                addSlide: function (e, t) {
                    ...
                    if (e <= 0) a.prependSlide(t);
                        ...
                        s.loop && a.loopCreate(), s.observer && p.observer || a.update(), s.loop ? a.slideTo(o + a.loopedSlides, 0, !1) : a.slideTo(o, 0, !1)
                    }
                },
        ...
        var x, E = {
                attachEvents: function () {
                    ...
                    a.onTouchStart = function (a) {
                            ...
                            if (l.originalEvent && (l = l.originalEvent), r.isTouchEvent = "touchstart" === l.type, (r.isTouchEvent || !("which" in l) || 3 !== l.which) && (!r.isTouched || !r.isMoved))
                                ...
                                if (!u || !(p <= h || p >= t.screen.width - h)) {
                                    if (d.extend(r, {
                                            ...
                                            isScrolling: void 0,
                                            startMoving: void 0
                                        }), o.startX = p, o.startY = c, r.touchStartTime = d.now(), s.allowClick = !0, s.updateSize(), s.swipeDirection = void 0, 0 < n.threshold && (r.allowThresholdMove = !1), "touchstart" !== l.type) {
                                        var v = !0;
                                        i(l.target).is(r.formElements) && (v = !1), e.activeElement && i(e.activeElement).is(r.formElements) && e.activeElement !== l.target && e.activeElement.blur(), v && s.allowTouchMove && l.preventDefault()
                                    }
                                    s.emit("touchStart", l)
                                }
                            }
                        ...
                        if (l.originalEvent && (l = l.originalEvent), s.isTouched) {
                            if (!s.isTouchEvent || "mousemove" !== l.type) {
                                ...
                                if (!a.allowTouchMove) return a.allowClick = !1, void(s.isTouched && (d.extend(n, {
                                    startX: p,
                                    startY: c,
                                    currentX: p,
                                    currentY: c
                        ...
                        if (t.allowClick && (t.updateClickedSlide(p), t.emit("tap", p), h < 300 && 300 < u - a.lastClickTime && (a.clickTimeout && clearTimeout(a.clickTimeout), a.clickTimeout = d.nextTick((function () {
                                t && !t.destroyed && t.emit("click", p)
                            }), 300)), h < 300 && u - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit("doubleTap", p))), a.lastClickTime = d.now(), d.nextTick((function () {
                        ...
                        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, c = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, i.freeMode) {
                            ...
                            if (i.freeModeMomentum) {
                                if (1 < a.velocities.length) {
                                    var v = a.velocities.pop(),
                                        ...
                                        g = v.time - f.time;
                                    t.velocity = m / g, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (150 < g || 300 < d.now() - v.time) && (t.velocity = 0)
                                } else t.velocity = 0;
                                ...
                                if (y < t.maxTranslate()) i.freeModeMomentumBounce ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S), x = t.maxTranslate(), T = !0, a.allowMomentumBounce = !0) : y = t.maxTranslate(), i.loop && i.centeredSlides && (E = !0);
                                else if (y > t.minTranslate()) i.freeModeMomentumBounce ? (y - t.minTranslate() > S && (y = t.minTranslate() + S), x = t.minTranslate(), T = !0, a.allowMomentumBounce = !0) : y = t.minTranslate(), i.loop && i.centeredSlides && (E = !0);
                                ...
                                i.freeModeMomentumBounce && T ? (t.updateProgress(x), t.setTransition(b), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd((function () {
                            ...
                            for (var z = 0, k = t.slidesSizesGrid[0], P = 0; P < o.length; P += i.slidesPerGroup) void 0 !== o[P + i.slidesPerGroup] ? c >= o[P] && c < o[P + i.slidesPerGroup] && (k = o[(z = P) + i.slidesPerGroup] - o[P]) : c >= o[P] && (z = P, k = o[o.length - 1] - o[o.length - 2]);
                            var $ = (c - o[z]) / k;
                            if (h > i.longSwipesMs) {
                    ...
                    if (p.touch || !p.pointerEvents && !p.prefixedPointerEvents) {
                        if (p.touch) {
                            var u = !("touchstart" !== r.start || !p.passiveListener || !s.passiveListeners) && {
                                passive: !0,
                                capture: !1
                            };
                            l.addEventListener(r.start, a.onTouchStart, u), l.addEventListener(r.move, a.onTouchMove, p.passiveListener ? {
                                passive: !1,
                                capture: c
                            } : c), l.addEventListener(r.end, a.onTouchEnd, u)
                        }(s.simulateTouch && !w.ios && !w.android || s.simulateTouch && !p.touch && w.ios) && (l.addEventListener("mousedown", a.onTouchStart, !1), e.addEventListener("mousemove", a.onTouchMove, c), e.addEventListener("mouseup", a.onTouchEnd, !1))
                    } else l.addEventListener(r.start, a.onTouchStart, !1), e.addEventListener(r.move, a.onTouchMove, c), e.addEventListener(r.end, a.onTouchEnd, !1);
                    (s.preventClicks || s.preventClicksPropagation) && l.addEventListener("click", a.onClick, !0), a.on(w.ios || w.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", y, !0)
                },
                detachEvents: function () {
                    ...
                    if (p.touch || !p.pointerEvents && !p.prefixedPointerEvents) {
                        ...
                        }(a.simulateTouch && !w.ios && !w.android || a.simulateTouch && !p.touch && w.ios) && (n.removeEventListener("mousedown", t.onTouchStart, !1), e.removeEventListener("mousemove", t.onTouchMove, o), e.removeEventListener("mouseup", t.onTouchEnd, !1))
                    ...
                    (a.preventClicks || a.preventClicksPropagation) && n.removeEventListener("click", t.onClick, !0), t.off(w.ios || w.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", y)
                }
            },
            T = {
                ...
                classes: {
                    addClasses: function () {
                        var e = this.classNames,
                            ...
                            i = this.$el,
                            s = [];
                        s.push(t.direction), t.freeMode && s.push("free-mode"), p.flexbox || s.push("no-flexbox"), t.autoHeight && s.push("autoheight"), a && s.push("rtl"), 1 < t.slidesPerColumn && s.push("multirow"), w.android && s.push("android"), w.ios && s.push("ios"), S.isIE && (p.pointerEvents || p.prefixedPointerEvents) && s.push("wp8-" + t.direction), s.forEach((function (a) {
            ...
            k = function (e) {
                function t() {
                    ...
                    1 === n.length && n[0].constructor && n[0].constructor === Object ? r = n[0] : (s = (a = n)[0], r = a[1]), r || (r = {}), r = d.extend({}, r), s && !r.el && (r.el = s), e.call(this, r), Object.keys(M).forEach((function (e) {
                    ...
                    if (s = u[0]) {
                        ...
                        return d.extend(l, {
                            ...
                            touchEvents: (v = ["touchstart", "touchmove", "touchend"], f = ["mousedown", "mousemove", "mouseup"], p.pointerEvents ? f = ["pointerdown", "pointermove", "pointerup"] : p.prefixedPointerEvents && (f = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), l.touchEventsTouch = {
                                start: v[0],
                                move: v[1],
                                end: v[2]
            ...
            A = {
                update: function (e) {
                    ...
                    v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", r ? (f = Math.floor(i / 2) + s, m = Math.floor(i / 2) + s) : (f = i + (s - 1), m = s);
                    var b = Math.max((g || 0) - m, 0),
                        w = Math.min((g || 0) + f, p.length - 1),
                    ...
                    if (d.extend(t.virtual, {
                        ...
                        }), o === b && l === w && !e) return t.slidesGrid !== c && y !== h && t.slides.css(v, y + "px"), void t.updateProgress();
                    ...
                    if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                        ...
                        for (var S = o; S <= l; S += 1)(S < b || w < S) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + S + '"]').remove();
                    for (var C = 0; C < p.length; C += 1) b <= C && C <= w && (void 0 === l || e ? T.push(C) : (l < C && T.push(C), C < o && E.push(C)));
                    T.forEach((function (e) {
            ...
            B = {
                ...
                enable: function () {
                    ...
                    var t = e.$el;
                    return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.on("mouseenter", e.mousewheel.handleMouseEnter), t.on("mouseleave", e.mousewheel.handleMouseLeave), t.on(B.event, e.mousewheel.handle), e.mousewheel.enabled = !0
                },
                disable: function () {
                    var e = this;
                    if (!B.event) return !1;
                    if (!e.mousewheel.enabled) return !1;
                    var t = e.$el;
                    return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.off(B.event, e.mousewheel.handle), !(e.mousewheel.enabled = !1)
                }
            },
            X = {
                update: function () {
            ...
            V = {
                ...
                updateSize: function () {
                    ...
                    if (e.params.scrollbar.el && e.scrollbar.el) {
                        ...
                        var s, r = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                            ...
                            o = n * (r / e.size);
                        s = "auto" === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = s + "px" : a[0].style.height = s + "px", i[0].style.display = 1 <= n ? "none" : "", e.params.scrollbarHide && (i[0].style.opacity = 0), d.extend(t, {
                            trackSize: r,
                            divider: n,
                            moveDivider: o,
                            dragSize: s
                ...
                onDragEnd: function (e) {
                    var t = this,
                        a = t.params.scrollbar,
                        i = t.scrollbar.$el;
                    t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, a.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar.dragTimeout = d.nextTick((function () {
                ...
                disableDraggable: function () {
                    ...
                    if (t.params.scrollbar.el) {
                        ...
                        p.touch || !p.pointerEvents && !p.prefixedPointerEvents ? (p.touch && (n.removeEventListener(i.start, t.scrollbar.onDragStart, o), n.removeEventListener(i.move, t.scrollbar.onDragMove, o), n.removeEventListener(i.end, t.scrollbar.onDragEnd, l)), (r.simulateTouch && !w.ios && !w.android || r.simulateTouch && !p.touch && w.ios) && (n.removeEventListener("mousedown", t.scrollbar.onDragStart, o), e.removeEventListener("mousemove", t.scrollbar.onDragMove, o), e.removeEventListener("mouseup", t.scrollbar.onDragEnd, l))) : (n.removeEventListener(s.start, t.scrollbar.onDragStart, o), e.removeEventListener(s.move, t.scrollbar.onDragMove, o), e.removeEventListener(s.end, t.scrollbar.onDragEnd, l))
                    }
                },
                init: function () {
                    var e = this;
                    if (e.params.scrollbar.el) {
                        ...
                        0 === n.length && (n = i('<div class="' + e.params.scrollbar.dragClass + '"></div>'), r.append(n)), d.extend(t, {
                            $el: r,
                            el: r[0],
                            $dragEl: n,
                            dragEl: n[0]
            ...
            q = {
                ...
                setTransition: function (e, t) {
                    ...
                    if (Array.isArray(s))
                        for (a = 0; a < s.length; a += 1) s[a] !== t && s[a] instanceof k && r(s[a]);
            ...
            K = {
                init: function () {
                    ...
                    if (e.params.history) {
                        ...
                        var a = e.history;
                        a.initialized = !0, a.paths = K.getPathValues(), (a.paths.key || a.paths.value) && (a.scrollToSlide(0, a.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", e.history.setHistoryPopState))
                    }
                },
                destroy: function () {
            ...
            _ = {
                run: function () {
                    ...
                    t.attr("data-swiper-autoplay") && (a = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), e.autoplay.timeout = d.nextTick((function () {
            ...
            Q = {
                setTranslate: function () {
                    ...
                    for (var v = 0; v < r.length; v += 1) {
                        ...
                        if (w <= 1 && -1 < w && (h = 90 * m + 90 * w, l && (h = 90 * -m - 90 * w)), f.transform(T), p.slideShadows) {
                            var C = c ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"),
                                M = c ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");
                            0 === C.length && (C = i('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), f.append(C)), 0 === M.length && (M = i('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), f.append(M)), C.length && (C[0].style.opacity = Math.max(-w, 0)), M.length && (M[0].style.opacity = Math.max(w, 0))
                        }
                    }
                    if (s.css({
                        ...
                        } var I = S.isSafari || S.isUiWebView ? -d / 2 : 0;
            ...
            ee = {
                setTranslate: function () {
                    for (var e = this, t = e.width, a = e.height, s = e.slides, r = e.$wrapperEl, n = e.slidesSizesGrid, o = e.params.coverflowEffect, l = e.isHorizontal(), d = e.translate, c = l ? t / 2 - d : a / 2 - d, u = l ? o.rotate : -o.rotate, h = o.depth, v = 0, f = s.length; v < f; v += 1) {
                        var m = s.eq(v),
                            g = n[v],
            ...
            te = [P, $, L, I, O, N, G, {
                ...
                on: {
                    ...
                    click: function (e) {
                        var t = this.navigation,
                            a = t.$nextEl,
                            s = t.$prevEl;
                        !this.params.navigation.hideOnClick || i(e.target).is(s) || i(e.target).is(a) || (a && a.toggleClass(this.params.navigation.hiddenClass), s && s.toggleClass(this.params.navigation.hiddenClass))
                    }
                }
            }, {
                name: "pagination",
                ...
                on: {
                    ...
                    click: function (e) {
                        var t = this;
                        t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !i(e.target).hasClass(t.params.pagination.bulletClass) && t.pagination.$el.toggleClass(t.params.pagination.hiddenClass)
                    }
                }
            }, {
                name: "scrollbar",
